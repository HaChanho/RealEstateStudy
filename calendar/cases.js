...
window.AUCTION_CASES = [
  ...
  },
  {
    ...
    "rating": null,
    "verdict": "hold",
    "verdictReason": "관망 / 마진형 저가 한정 — 보수 매도 기준 1.73억(최근 실거래 (현 호가 0건)) · 입찰권장 1.56억(70%) · 세전 EP70 1052만원(watchlist) · 세후 878만원. 권리 raw 미검증(D-day 등기·임차조사 확인 필요). (2026-06-03 v9 재분석) — [v10.1 카페재분석] 🔻유동성 최악: 외곽(병천)+실거래0+구축 → 매도 장기화 위험 HIGH. EP70도 낮아 비추 강화.",
    "tags": [
      "천안동남",
      "모드니에",
      "외곽",
  ...
  },
  {
    ...
    "rating": null,
    "verdict": "hold",
    "verdictReason": "관망 / 마진형 저가 한정 — 보수 매도 기준 1.98억(호가 하단) · 입찰권장 1.78억(70%) · 세전 EP70 1237만원(watchlist) · 세후 1033만원. 권리 raw 미검증(D-day 등기·임차조사 확인 필요). (2026-06-03 v9 재분석) — [v10.1 카페재분석] 5층 저층 경계 — 유동성 mild 주의, 산단 임대 완충.",
    "tags": [
      "아산",
      "이지더원",
      "준과열",
  ...
  },
  {
    ...
    "rating": null,
    "verdict": "hold",
    "verdictReason": "관망 / 마진형 저가 한정 — 보수 매도 기준 2.19억(최근 실거래(호가보다 낮음)) · 입찰권장 1.97억(70%) · 세전 EP70 1394만원(watchlist) · 세후 1164만원. 권리 raw 미검증(D-day 등기·임차조사 확인 필요). (2026-06-03 v9 재분석) — [v10.1 카페재분석] 중층·80㎡=유동성 양호. 같은단지 31평형 재매각(대금미납) 이력 주의. 권리 D-day 검증.",
    "tags": [
      "아산",
      "이지더원2단지",
      "재매각",
  ...
  },
  {
    ...
    "rating": null,
    "verdict": "candidate",
    "verdictReason": "조건부 GO (수익 ◇) — 보수 매도 기준 1.93억(호가 하단) · 입찰권장 1.64억(70%) · 세전 EP70 2192만원(watch) · 세후 1830만원. 권리 raw 미검증(D-day 등기·임차조사 확인 필요). (2026-06-03 v9 재분석) — [v10.1 카페재분석] ⚠️저층(2층): 카페 유동성 학습상 저층은 매도 8개월+ 위험 → top EP70이나 보유 장기화 시 마진잠식·매도난이도. 5명 저경쟁은 강점. 충남 비조정=종소세 단일과세.",
    "tags": [
      "아산",
      "용화마을신도브래뉴",
      "저경쟁",
  ...
  },
  {
    ...
    "rating": null,
    "verdict": "candidate",
    "verdictReason": "조건부 GO (수익 ◇) — 보수 매도 기준 2.45억(최근 실거래(호가보다 낮음)) · 입찰권장 2.21억(70%) · 세전 EP70 1588만원(watch) · 세후 1326만원. 권리 raw 미검증(D-day 등기·임차조사 확인 필요). (2026-06-03 v9 재분석) — [v10.1 카페재분석] ✅공실→명도 용이(명도비 참고치 하향 여지). 단 보령 외곽+20년 구축 → 유동성 주의.",
    "tags": [
      "보령",
      "정은스카이빌",
      "추정신뢰낮음",
  ...
  },
  {
    ...
    "rating": null,
    "verdict": "candidate",
    "verdictReason": "조건부 GO (수익 ◇) — 보수 매도 기준 3.13억(호가 하단) · 입찰권장 2.82억(70%) · 세전 EP70 2092만원(watch) · 세후 1747만원. 권리 raw 미검증(D-day 등기·임차조사 확인 필요). (2026-06-03 v9 재분석) — [v10.1 카페재분석] 3층 저층이나 신축(≤8년)·85㎡주력·산단 배후로 완충. 저층 유동성 주의하며 ◇ 유지.",
    "tags": [
      "아산",
      "이지더원9단지",
      "준과열",
  ...
  },
  {
    ...
    "rating": null,
    "verdict": "hold",
    "verdictReason": "관망 / 마진형 저가 한정 — 보수 매도 기준 1.84억(호가 하단) · 입찰권장 1.66억(70%) · 세전 EP70 1134만원(watchlist) · 세후 947만원. 권리 A 검증·인수 0. (2026-06-03 v9 재분석) — [v10.1 카페재분석] 이녹스(법인) 임차인 전입·확정 없음=대항요건 불비→인수0 (권리 케이스북 재확인). 과열단지 주의. 비조정 단일과세.",
    "tags": [
      "아산",
      "이지더원2단지",
      "deep-dive",
  ...
  },
  {
    ...
    "rating": null,
    "verdict": "candidate",
    "verdictReason": "조건부 GO (수익 ◇) — 보수 매도 기준 3.03억(최근 실거래(호가보다 낮음)) · 입찰권장 2.73억(70%) · 세전 EP70 2019만원(watch) · 세후 1686만원. 권리 A 검증·인수 0. (2026-06-03 v9 재분석) — [v10.1 카페재분석] ✅2,144세대 대단지·중층·신축급=유동성 최우량(카페 '층/타입이 회전속도 좌우'에 부합)·소유자점유=명도 용이. 비조정 단일과세.",
    "tags": [
      "천안동남",
      "신부디이스트",
      "deep-dive",
  ...
  },
  {
    ...
    "rating": null,
    "verdict": "hold",
    "verdictReason": "관망 / 마진형 저가 한정 — 보수 매도 기준 2.12억(호가 하단) · 입찰권장 1.90억(70%) · 세전 EP70 1339만원(watchlist) · 세후 1118만원. 권리 raw 미검증(D-day 등기·임차조사 확인 필요). (2026-06-03 v9 재분석) — [v10.1 카페재분석] ⚠️연체 공용관리비 400만 낙찰자 인수(카페 명도 학습) — 비용 반영. 85㎡주력=유동성 양호. 권리 D-day 검증 필요.",
    "tags": [
      "아산",
      "대우푸르지오",
      "v7재계산",
